...
question("What does the coefficient estimate tell us about the relationship between seat share and the share of opposing votes to the government?",
  ...
  answer("An increase of one percentage point in seat share is associated with a an increase of about 0.56 percentage points in the the share of votes against the government.", correct = T),
